...
# Filter residential
res_listing = pd.read_csv("res_CRMLSListing_202401_to_202603.csv")
res_sold = pd.read_csv("res_CRMLSSold_202401_to_202603.csv")
...
null_filter_listing.to_csv("null_CRMLSListing_202401_to_202603.csv")
null_filter_sold.to_csv("null_CRMLSSold_202401_to_202603.csv")